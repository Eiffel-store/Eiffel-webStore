          ...
          <div className="md:col-span-5 space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-[#25D366] text-white text-xs font-mono font-bold tracking-wider uppercase hover:bg-[#20ba5a] transition-all shadow-md"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2.5 bg-[#1877F2] text-white text-xs font-mono font-bold tracking-wider uppercase hover:bg-[#166fe5] transition-all shadow-md"
              >
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-zinc-400 font-light">
                ...
                <li><Link to="/collections/shoes" className="hover:text-white transition-colors">{t.navShoes}</Link></li>
                <li><Link to="/collections/offers" className="hover:text-white transition-colors">{t.navOffers || t.navCollection04}</Link></li>
              </ul>
            </div>
