...
import { useCurrency, useStoreData, CachedImage } from '@/shared';
        ...
        <div className="flex justify-between items-center mt-2">
          <div className="flex items-center border border-surface-container dark:border-zinc-700 bg-surface-container-low dark:bg-zinc-900">
            ...
            <button
              ...
              className="p-1 sm:p-1.5 hover:bg-zinc-800 text-zinc-300 disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer"
              title={quantity >= maxAllowed ? `الحد الأقصى ${maxAllowed} قطع` : undefined}
            >
