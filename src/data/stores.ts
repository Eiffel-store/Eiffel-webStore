...
export const STORES: StoreLocation[] = [
  ...
  },
  {
    id: 'nahtay-branch',
    city: 'Nahtay (Gharbia)',
    name: 'Eiffel Boutique — Nahtay',
    address: 'نهطاي، على الطريق بجوار كشري الإمبراطور، محافظة الغربية، مصر',
    hours: 'Daily: 11:00 AM – 12:00 AM (يومياً: 11 صباحاً – 12 منتصف الليل)',
    phone: '+20 (WhatsApp / Contact)',
    email: 'contact@eiffel-store.com',
    type: 'Boutique',
    coordinates: { x: 52, y: 42 },
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBGK249_0hL_G3-k-209iRrhbN9_y1qYtI2206iXmCvdzH-5Y3Hn5q46G0fC_gN2s9hF4r-Bf1yW1s7902a2Wd07qM-g08i6R43uK0cR_gZ99v2XbQ'
  }
];
